...
const swiperMain = setupSwiper2('zoom', 1, false, false, false, true);
swiperMain.watchOverflow: true,
        swiperMain.watchSlidesVisibility: true,
        swiperMain.watchSlidesProgress: true,
        swiperMain.preventInteractionOnTransition: true,
swiperMain.thumbs = { swiper: swiperList };
